...
<nav class="navbar navbar-expand navbar-dark bg-dark">
        <ul class="navbar-nav">
            ...
            ?>
            <li class="active nav-item"><a class="nav-link " href="validation_mission.php">Validation des missions</a></li>
        ...
        if (!empty($_SESSION)) {
            if ($_SESSION['Rang'] == 0) {
                ...
                while ($res = $resultat -> fetch()) {
                    ...
                    ");
                    if ($res['valide'] == 0) {
                        $valide = "<form method='POST' action='php/valide_mission.php'><input type='hidden' name='id' value='".$res['idMission']."'><button class='btn btn-primary' type='submit'>Valider</button></form>";
                        echo("  <td>".$valide."</td>
                                </tr>
                        ");
                    } else {
